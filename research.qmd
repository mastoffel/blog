...
1\) [Genetic architecture and lifetime dynamics of inbreeding depression in a wild mammal](https://www.nature.com/articles/s41467-021-23222-9).\
*Nat Comms* (2021), [Code](https://github.com/mastoffel/sheep_ID).

::: columns
::: {.callout-tip .column collapse="true" width="20%"}
# short and sweet
...
::: {.callout-warning .column collapse="true" width="20%"}
# doubts
...
2\) [Demographic histories and genetic diversity across pinnipeds are shaped by human exploitation, ecology and life-history](https://www.nature.com/articles/s41467-018-06695-z).\
*Nat Comms* (2018) \| [Code](https://github.com/mastoffel/pinniped_bottlenecks)

::: columns
::: {.callout-tip .column collapse="true" width="50%"}
# short and sweet
...
::: {.callout-warning .column collapse="true" width="50%"}
# doubts
