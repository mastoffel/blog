...
A neural [:vocoder](https://en.wikipedia.org/wiki/Vocoder) to reconstruct a waveform from a spectrogram, trained on cat meows. [code](https://github.com/mastoffel/neural_vocoder/blob/main/neural_vocoder.ipynb)
:::
