...
- Hard to read  
- Iris df gets re-assigned a lot
...
Last tip: AI is your friend. If you're stuck, put your pandas code in chatgpt or co-pilot and ask it to re-write code as a pipe. Seems to work pretty well.
