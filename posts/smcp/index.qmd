...
The [Model Context Protocol (MCP)](https://modelcontextprotocol.io/introduction) defines a standardised interface between *things* and AI. Until MCP, LLMs like ChatGPT or Claude had to figure out where to look for data, how to use an application, or how to navigate a website. This often goes wrong, because apps are all different, and data is often not accessible. 
